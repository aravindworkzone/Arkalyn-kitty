...
const groupEventSchema = new mongoose.Schema({
    ...
    eventType: { type: String, enum: ["MANAGE_MEMBER", "CHANGE_ROLE", "CREATE_GROUP", "CREDIT", "DEBIT"], required: true },
    referenceId: { type: mongoose.Schema.Types.ObjectId, default: null },
    referenceModel: { type: String, enum: ["expense", "group"], default: null },
