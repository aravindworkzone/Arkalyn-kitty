...
interface IGroupEvent extends Document {
    ...
    eventType: "MEMBER_ADDED" | "MEMBER_REMOVED" | "MANAGE_CATEGORY" | "CHANGE_ROLE" | "CREATE_GROUP" | "GROUP_CLOSED" | "CREDIT_REMOVED" | "EXPENSE_EDITED";
...
const groupEventSchema = new Schema<IGroupEvent>({
    ...
    eventType: { type: String, enum: ["MEMBER_ADDED", "MEMBER_REMOVED", "MANAGE_CATEGORY", "CHANGE_ROLE", "CREATE_GROUP", "GROUP_CLOSED", "CREDIT_REMOVED", "EXPENSE_EDITED"], required: true },
