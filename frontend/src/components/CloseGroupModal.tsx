...
export default function CloseGroupModal({ isOpen, groupId, onClose, onClosed }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-[2px]">
      ...
      <div className="relative w-full max-w-[560px] rounded-2xl border border-white/[0.08] bg-[#080c14] px-6 py-6 shadow-2xl animate-[fadeUp_0.18s_ease-out] max-h-[90vh] flex flex-col">
