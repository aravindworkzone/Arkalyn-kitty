      ...
      <div className="flex items-center gap-2">
        ...
        <div ref={dropdownRef} className="relative">
          ...
          >
            ...
            <span className="text-[12px] font-medium text-white/55 max-w-[80px] truncate">
              {firstName}
            </span>
            <svg
            ...
            <div className="absolute top-[calc(100%+6px)] right-0 w-[210px]
              ...
              <div className="px-3.5 py-3 border-b border-white/[0.07]">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="text-[13px] font-semibold text-[#f0eeff] truncate leading-tight">
                      {user?.name}
                    </p>
              ...
              <div className="p-1.5 space-y-0.5">
                <button className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg
                  text-[12px] font-medium text-white/45 hover:text-white/80
                  hover:bg-white/[0.05] transition-all duration-100 group">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg
                    text-[12px] font-medium text-white/45 hover:text-red-300
                    hover:bg-red-500/[0.08] transition-all duration-100 group"
                >
                  <svg width="13" height="13" viewBox="0 0 13 13" fill="none"
